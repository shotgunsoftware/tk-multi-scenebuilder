...
$UI_PYTHON_PATH="../python/tk_multi_scenebuilder/ui"

# the paths to where the PySide binaries are installed
$PYTHON_EXE="R:/Softwares/Autodesk/Shotgun1.5.9/Python/python.exe"
$PYTHON_UIC="R:/Softwares/Autodesk/Shotgun1.5.9/Python/Lib/site-packages/PySide/scripts/uic.py"
$PYTHON_RCC="R:/Softwares/Autodesk/Shotgun1.5.9/Python/Lib/site-packages/PySide/pyside-rcc.exe"
